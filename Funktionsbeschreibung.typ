...
Der Therapieplan ist das Herzstück des Systems. Er enthält alle relevanten Informationen zu den Therapien, die ein Patient durchführt. Der Therapieplan kann vom Arzt, Apotheker oder auch vom Patienten erstellt werden.  Die Erstellung soll durch das manuelle Aufsetzen möglich sein oder durch den Scan einer ausgedruckten oder handgeschriebenen Verordnung möglich sein. Der Therapieplan umfasst Informationen zu den Medikamenten, Dosierungen, Einnahmezeiten und weiteren relevanten Aspekten der Therapie. Der Therapieplan kann jederzeit aktualisiert werden, um Änderungen in der Therapie zu berücksichtigen.
...
== Erinnerungsfunktion
Die Erinnerungsfunktion ist eine wichtige Komponente des Systems, die den Patienten daran erinnert, ihre Medikamente rechtzeitig einzunehmen. Der Patient kann individuelle Erinnerungen für jedes Medikament festlegen, einschließlich der Uhrzeit und Häufigkeit und Dosis der Einnahme. Das System sendet Benachrichtigungen an den Patienten, um sicherzustellen, dass er keine Dosis vergisst. 

== Medikamentenverwaltung
Die Medikamentenverwaltung ermöglicht es dem Patienten, alle Informationen zu den eingenommenen Medikamenten zu verwalten. Dazu gehören Informationen zu den Medikamenten selbst, wie Name, Dosierung, Einnahmezeiten und Nebenwirkungen. Der Patient kann auch Notizen zu den Medikamenten hinzufügen, um wichtige Informationen festzuhalten.
Die Medikamentenverwaltung ermöglicht es dem Patienten, den Überblick über seine Medikamente zu behalten und sicherzustellen, dass er alle notwendigen Informationen hat. 
